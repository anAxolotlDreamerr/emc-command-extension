...
public record Chunk(int x, int z) {
    ...
    public Line northEdge(){
        return new Line(new Coordinate(x*16,z*16),new Coordinate(x*16+15,z*16));
    }
    public Line westEdge(){
        return new Line(new Coordinate(x*16,z*16),new Coordinate(x*16,z*16+15));
    }
    public Line eastEdge(){
        return new Line(new Coordinate(x*16+15,z*16),new Coordinate(x*16+15,z*16+15));
    }
    public Line southEdge(){
        return new Line(new Coordinate(x*16,z*16+15),new Coordinate(x*16+15,z*16+15));
    }
